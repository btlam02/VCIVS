...
const App = () => {
  ...
  const settings = {
    ...
    slidesToScroll: 1,
    centerMode: true,
    centerPadding: "20%", // hoặc bạn có thể thử với giá trị khác
  };
  return (
    <div className="App">
      <h1>
      ...
      <h1 style={{ marginTop: 100 }}>Voice Test</h1>
      <div id="voice-list">
        {voices.map((voice) => (
      ...
      <div style={{ marginTop: 100} }>
        ...
        <Slider {...settings}>
          ...
          <div>
            <img src="./images/img-web2.png" alt="Image 2" />
          </div>
          <div>
            <img src="./images/img-web3.png" alt="Image 3" />
          </div>
          <div>
            <img src="./images/img-web4.png" alt="Image 3" />
          </div>
      ...
      <div style={{ marginTop: 200 }}>
        ...
        >
          <div>
            ...
            <p>Email: dghthuong@hmcus.edu.vn</p>
          </div>
          <div>
